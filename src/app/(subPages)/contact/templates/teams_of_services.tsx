  ...
  return (
    <VStack id='teams_of_services' pt='6rem' pb='4rem'>
      ...
      >
        ...
        <Text textAlign='left' fontSize={{ base: 'md' }}>
          ・器材(フィン、マスク、スノーケルなど)のレンタルを受ける際に、正しい使用方法に沿って取り扱います。
          <br />
          それ以外での使用方法でのレンタル器材の破損、紛失、盗難に際しては速やかに弁償します。
        </Text>
        ...
        <Text textAlign='left' fontSize={{ base: 'md' }}>
          ・ツアー中は決められたバディシステムのもと単独での遊泳をせず、安全のためガイドの指示に従います。
        </Text>

        <Text textAlign='left' fontSize={{ base: 'md' }}>
          ・ツアー中にガイドの指示に従わずに発生した事故、不測の事態から生じる事故ついては自身で責任を負うとともに、自身の健康管理に細心の注意を払ってツアーに参加します。
        </Text>
